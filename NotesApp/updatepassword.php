...
$invalidPassword = '<p><strong>Your password should be atleast of 6 characters long and include one capital letter and one number!</strong></p>';
...
if($errors){
  ...
  //else run a query and update password
