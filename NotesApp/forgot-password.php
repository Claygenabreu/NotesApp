...
//print error message
if($count != 1){
  echo '<div class="alert alert-danger">That email does not exist on the database.</div>'; exit;
}
// else
//  get the user_id 
...
//Insert user details and activation code on the forgot password table
$time = time();
$status = 'pending';
